...
```{r crd plot interaction pwc nitrogen (n) inside potassium (k) rates, warning=FALSE, message=FALSE}
...
ggplot() +
  ...
  geom_boxplot(data = crd_adfw,
               aes(x = krate_kgha, y = yield_kgha,
                   color = krate_kgha )) + #We want to see the nitrogen rate in the x axis for all levels of potassium rates
  geom_jitter() +
